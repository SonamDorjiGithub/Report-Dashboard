    ...
    <div class="card mb-4">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <button class="float-right btn-primary btn-xs" id="prepaid-download-xlsx"><i class="fas fa-file-download"></i></button>
                    <button class="float-right btn-primary btn-xs hide" id="prepaidajax-download-xlsx"><i class="fas fa-file-download"></i></button>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <!-- Tab panes -->
            <div class="tab-content" id="prepaidmonthlytab">
                @foreach($yearall as $year)
    ...
    <script>
        ...
        var table = new Tabulator("#prepaid-table", {
            ...
            dataLoaded:function(data){ //freeze first row on data load
                var lastRow = this.getRows()[{{count($tableprepaid) - 1}}];
        ...
        document.getElementById("prepaid-download-xlsx").addEventListener("click", function(){
            table.download("xlsx", "prepaid.xlsx");
        });
    </script>
@endsection
